        ...
        <Table sx={{ minWidth: 650 }} aria-label="invoice items table">
          ...
          <TableBody>
            ...
            <TableRow>
              ...
              <TableCell align="right">
                <strong>{totalAmount.toFixed(2)} TND</strong>
              </TableCell>
            </TableRow>
          </TableBody>
        </Table>
...
const StepThree = ({ formData }) => (
  <Stack spacing={2}>
    ...
    <Paper sx={{ p: 2 }}>
      ...
      <Typography>
        <strong>Date de facturation:</strong> {formData.invoice_date}
      </Typography>
      <Typography>
        <strong>Date d'échéance:</strong> {formData.due_date}
      </Typography>
      <Typography sx={{ mt: 2 }}>
        <strong>Total:</strong>{" "}
        {(formData.line_items || [])
      ...
      <Container maxWidth="lg">
        <Card sx={{ border: (theme) => `1px solid ${theme.palette.divider}`, boxShadow: "none" }}>
          <CardContent sx={{ padding: "40px" }}>
            ...
            <Typography sx={{ mb: 4 }}>
              Basée sur le bon de commande:{" "}
              <strong>{purchaseOrder?.poNumber || purchaseOrderId}</strong>
            </Typography>
            ...
            <Box sx={{ mb: 4, minHeight: "300px" }}>{renderStepContent()}</Box>
