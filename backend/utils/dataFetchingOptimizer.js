...
class DataFetchingOptimizer {
  static COLUMN_SELECTS = {
    tender_list: 'id, tender_number, title, category, budget_min, budget_max, deadline, status, is_public, buyer_id, created_at, first_offer_at',
    tender_detail: 'id, tender_number, title, description, category, budget_min, budget_max, currency, status, deadline, opening_date, requirements, attachments, buyer_id, is_public, evaluation_criteria, created_at, updated_at, allow_partial_award, max_winners',
    offer_list: 'id, offer_number, tender_id, supplier_id, total_amount, currency, status, submitted_at, technical_score, financial_score, final_score, ranking, award_status, awarded_at, is_locked',
    offer_detail: 'id, offer_number, tender_id, supplier_id, total_amount, currency, delivery_time, payment_terms, status, technical_score, financial_score, final_score, ranking, submitted_at, award_status, awarded_at, created_at, technical_evaluated_at, financial_evaluated_at, evaluation_completed_at, receipt_number, receipt_issued_at',
  ...
  static async prefetchSuppliers(pool, supplierIds) {
    ...
    try {
      ...
      const mapped = {};
      result.rows.forEach(supplier => { mapped[supplier.id] = supplier; });
      return mapped;
    } catch (error) {
