...
const testTenders = [
  {
    ...
    description: 'Buy office supplies for Q1 2025',
    budget_min: 5000,
    budget_max: 15000,
    category: 'Supplies',
  },
  {
    ...
    description: 'Buy laptops and servers',
    budget_min: 50000,
    budget_max: 100000,
    category: 'IT',
  },
...
async function seedData() {
  try {
    ...
    if (buyerId) {
      ...
      const suppliers = await pool.query('SELECT id FROM users WHERE role = $1 LIMIT 3', [
        'supplier',
      ]);
