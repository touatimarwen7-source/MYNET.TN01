    ...
    >
      <Container maxWidth="md">
        ...
        <Card sx={{ border: '1px solid #E0E0E0', mb: 3 }}>
          <CardHeader
            title={
              mfaEnabled ? 'Authentification activée' : "Activer l'authentification à deux facteurs"
            }
          />
          <CardContent>
            {mfaEnabled ? (
              ...
              <Box>
                <Typography sx={{ mb: 2 }}>
                  Utilisez une application d\'authentification (Google Authenticator, Authy) pour
                ...
                <TextField
                  fullWidth
                  label="Entrez le code d'authentification"
                  variant="outlined"
                  sx={{ mb: 2 }}
                />
                <Button
        ...
        <Card sx={{ border: '1px solid #E0E0E0' }}>
          ...
          <CardContent>
            <Alert severity="info" sx={{ mb: 2 }}>
              Conservez ces codes dans un endroit sûr à titre de sauvegarde:
            </Alert>
            <List>
