...
class DataMapper {
  ...
  static mapMessage(messageData) {
    const allowedFields = ['recipient_id', 'subject', 'body', 'attachment'];
  ...
  static mapSubscription(subscriptionData) {
    const allowedFields = ['plan_id', 'user_id', 'start_date', 'end_date', 'auto_renew', 'status'];
  ...
  static mapAddendum(addendumData) {
    const allowedFields = ['tender_id', 'title', 'description', 'attachment', 'effective_date'];
  ...
  static mapInquiry(inquiryData) {
    const allowedFields = ['tender_id', 'question', 'supplier_name', 'supplier_email'];
