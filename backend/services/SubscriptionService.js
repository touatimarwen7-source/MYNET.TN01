...
const ALL_FEATURES = [
  ...
  {
    key: 'extended_products',
    name: 'عدد منتجات أكثر (500)',
    ...
    try {
      ...
      const result = await pool.query(
        `INSERT INTO subscription_plans 
                 ...
                 RETURNING *`,
        [
          mappedData.plan_id || planData.name,
          planData.description,
          planData.price,
          planData.currency || 'TND',
          planData.duration_days,
          JSON.stringify(planData.features || {}),
          planData.max_tenders,
          planData.max_offers,
          planData.max_products || 50,
  ...
  async checkSubscriptionLimits(userId, type) {
    ...
    try {
      ...
      return {
        allowed: true,
        remaining:
          type === 'tender' ? subscription.max_tenders - count : subscription.max_offers - count,
      };
    } catch (error) {
