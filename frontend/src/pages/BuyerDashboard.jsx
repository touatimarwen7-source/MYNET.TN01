        ...
        <Box>
          ...
          <Box sx={{ mb: 4 }}>
            ...
            <Typography variant="body2" sx={{ color: '#666' }}>
              Bienvenue sur la plateforme d'appels d'offres avancée
            </Typography>
          </Box>
              ...
              <Stack spacing={2}>
                ...
                >
                  ...
                  <Typography variant="caption" sx={{ opacity: 0.9 }}>
                    Démarrez facilement un nouveau processus d'appel d'offres
                  </Typography>
                  <Button
                    fullWidth
                    variant="contained"
                ...
                >
                  ...
                  <Typography variant="caption" sx={{ opacity: 0.9 }}>
                    Envoyez une demande rapide à un fournisseur spécifique.
                  </Typography>
                  <Button
                    fullWidth
                    variant="contained"
    ...
    <Box sx={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
      ...
      <List sx={{ flex: 1, pt: 0 }}>
        {menuItems.map((item) => (
          ...
          >
            <ListItemIcon
              sx={{ minWidth: 40, color: activeSection === item.id ? '#0056B3' : 'inherit' }}
            >
              <item.icon />
            </ListItemIcon>
