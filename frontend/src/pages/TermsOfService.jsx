      ...
      <Box sx={{ maxWidth: '900px', mx: 'auto' }}>
        ...
        <Paper sx={{ p: 4, backgroundColor: theme.palette.background.default }}>
          ...
          <Typography sx={{ mb: 2, lineHeight: 1.8 }}>
            En utilisant MyNet.tn, vous acceptez ces conditions. Si vous n'acceptez pas, veuillez
          ...
          <Typography sx={{ mb: 2, lineHeight: 1.8 }}>
            Nous vous accordons une licence non exclusive, révocable pour accéder et utiliser la
            Plateforme conformément à ces conditions.
          </Typography>

          <Typography variant="h4" sx={{ mb: 3, color: theme.palette.primary.main, mt: 4 }}>
            3. Responsabilités de l'Utilisateur
          </Typography>
          <Typography sx={{ mb: 2, lineHeight: 1.8 }}>Vous êtes responsable de:</Typography>
          <Box sx={{ ml: 2, mb: 2 }}>
          ...
          <Typography sx={{ mb: 2, lineHeight: 1.8 }}>
            Vous conservez tous les droits sur votre contenu. En le publiant, vous nous accordez une
          ...
          <Typography sx={{ mb: 2, lineHeight: 1.8 }}>
            MyNet.tn est fourni "tel quel". Nous ne garantissons pas que la Plateforme fonctionnera
            sans interruption ou erreur.
          </Typography>

          <Typography variant="h4" sx={{ mb: 3, color: theme.palette.primary.main, mt: 4 }}>
            6. Interdictions
          </Typography>
          <Typography sx={{ mb: 2, lineHeight: 1.8 }}>Vous ne devez pas:</Typography>
          <Box sx={{ ml: 2, mb: 2 }}>
          ...
          <Typography sx={{ mb: 2, lineHeight: 1.8 }}>
            Nous pouvons résilier votre compte si vous violez ces conditions. Vous pouvez résilier
