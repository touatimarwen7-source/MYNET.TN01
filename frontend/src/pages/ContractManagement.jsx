            ...
            <Table>
              <TableHead sx={{ backgroundColor: '#f5f5f5' }}>
                <TableRow sx={{ height: '56px' }}>
                  <TableCell sx={{ fontWeight: 600, color: '#1565c0' }}>Numéro</TableCell>
                  <TableCell sx={{ fontWeight: 600, color: '#1565c0' }}>Fournisseur</TableCell>
                  <TableCell sx={{ fontWeight: 600, color: '#1565c0' }} align="right">Montant</TableCell>
                  <TableCell sx={{ fontWeight: 600, color: '#1565c0' }}>Statut</TableCell>
                  <TableCell sx={{ fontWeight: 600, color: '#1565c0' }}>Date Début</TableCell>
                  <TableCell sx={{ fontWeight: 600, color: '#1565c0' }}>Date Fin</TableCell>
                    ...
                    <TableCell align="center">
                      <Box sx={{ display: 'flex', gap: '8px', justifyContent: 'center' }}>
                        <Button
                          ...
                          sx={{ color: '#1565c0', borderColor: '#1565c0', textTransform: 'none' }}
                        >
                          Voir
                        </Button>
