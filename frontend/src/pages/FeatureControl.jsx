  ...
  const [features, setFeatures] = useState([
    {
      ...
      enabled: true,
      category: 'Core',
      description: "Système principal d'appels d'offres",
    },
    {
      id: 2,
    ...
    },
    {
      ...
      enabled: false,
      category: 'Advanced',
      description: 'Enchères en temps réel',
    },
    {
      id: 4,
    ...
    },
    {
      ...
      enabled: false,
      category: 'Community',
      description: 'Espace de discussion',
    },
    {
      id: 6,
      name: 'API externe',
    ...
    {
      id: 9,
      name: 'Beta: Chat en temps réel',
      enabled: false,
      category: 'Beta',
      description: 'Chat instantané (en développement)',
    },
  ]);
    ...
    <Box sx={{ backgroundColor: '#fafafa', paddingY: '40px', minHeight: '100vh' }}>
      <Container maxWidth="lg">
        ...
        <Alert severity="info" sx={{ marginTop: '24px' }}>
          💡 Conseil: Les changements de fonctionnalités sont appliqués immédiatement aux
