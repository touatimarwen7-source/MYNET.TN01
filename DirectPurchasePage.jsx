...
const DirectPurchasePage = () => {
  ...
  const addLineItem = () => {
    setFormData({
      ...
      lineItems: [
        ...formData.lineItems,
        { id: Date.now(), description: "", quantity: 1, unit: "Unit" },
      ],
    });
  };
              ...
              <form onSubmit={handleSubmit}>
                <Stack spacing={3}>
                  ...
                  {formErrors.lineItems && (
                    <Alert severity="error">{formErrors.lineItems}</Alert>
                  )}
                  <TableContainer component={Paper} sx={{ boxShadow: "none" }}>
                    <Table sx={{ minWidth: 650 }} aria-label="direct purchase items table">
                      <TableHead>
                        <TableRow>
                  ...
                  <DatePicker
                    ...
                    onChange={(newValue) =>
                      setFormData({ ...formData, deliveryDeadline: newValue })
                    }
                    renderInput={(params) => (
                      <TextField
                        {...params}
                        ...
                        helperText={formErrors.deliveryDeadline}
                      />
                    )}
                  />
